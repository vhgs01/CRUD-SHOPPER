<html>
    ...
    <body>
        ...
        $sql="SELECT 
         ...
         print '<tr><td>Nome</td> <td>Telefone</td><td>Email</td><td>Data Nascimento</td><td>Empresa</td><td>Endereco</td><td>Cidade</td><td>CEP</td><td>Estado</td><td>Pais</td><td>Numero Cartao</td><td>Numero CVV</td></tr>';
                while($stm->fetch()){
                    print '<tr>';
                        print '<td>'.$nome.'</td>';
